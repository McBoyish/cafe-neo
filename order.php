<?php 
session_start(); 
$_SESSION["logged"] = isset($_SESSION["logged"]) ? $_SESSION["logged"] : false;$menu = array();
  ...
  <body>
    <div class="banner">
      <div class="banner-content">
        ...
        <p>The delivery will be made at <?php echo $_SESSION["s_address"]; ?>.</p>
        <input type="button" onclick="location.href='home.php'" value="Back" id="submitbutton">
      </div>
    </div>
  </body>
